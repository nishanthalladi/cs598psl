...
myIBCF = function(w) {
  ...
  {
    recom_rankings[[col]] = sum(S[[col]] * w, na.rm=TRUE) / sum( (S[[col]] * !is.na(w)) != 0, na.rm=TRUE)
...
returned_rankings = myIBCF(ratings_mat_with_rownames["u1181",]) # Why does this take forever..?
...
```{r}
# Create test user who prefers animated movies
...
ratings_mat_with_rownames["u1181",]
```
